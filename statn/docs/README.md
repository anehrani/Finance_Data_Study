...
Welcome to the internal documentation for the `statn` workspace. This project provides a robust toolkit for quantitative trading model generation, statistical analysis, and backtesting.

## Documentation Index

### Core Library Modules
Detailed documentation for the underlying Rust libraries:
- [**Core**](core.md): Fundamental utilities, I/O, math, and statistical tests.
- [**Indicators**](indicators.md): Technical indicator definitions and computation logic.
- [**Models**](models.md): High-performance predictive models (Coordinate Descent, Differential Evolution).
- [**Estimators**](estimators.md): Specialized tools for bias estimation, sensitivity analysis, and optimization.
- [**Finance Tools**](finance_tools.md): Domain-specific financial utilities (ATR, outlier management).
- [**Backtesting**](backtesting.md): Simulation engine for strategy evaluation.

### Applications and experimental Tools
Documentation for the main entry points and trial utilities:
- [**Complete Model Generator**](complete_model_generator.md): The master orchestration tool for end-to-end model building.
- [**Model Discovery Tools**](model_discovery_tools.md): Experimental packages (`try_cd_ma`, `try_cd_comb`, etc.) for model search.
- [**Statistical Utility Tools**](statistical_tools.md): Overview of standalone binaries for data validation and risk assessment.

## Getting Started
To use these tools, navigate to the `statn` directory and use `cargo run`. Most tools will provide a usage message if run without arguments.
